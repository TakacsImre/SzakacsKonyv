...
--
-- Host: localhost    Database: receptek
-- ------------------------------------------------------
...
CREATE TABLE `hozzavalok` (
  `Sor` int(11) NOT NULL AUTO_INCREMENT,
  `Darab` int(11) NOT NULL,
  `ReceptID` int(11) NOT NULL,
  `ReceptNev` varchar(45) NOT NULL,
  `Mennyiseg` double NOT NULL,
  `Mertekegyseg` varchar(45) NOT NULL,
  `Alapanyag` varchar(45) NOT NULL,
  `Ara` int(11) DEFAULT '0',
  PRIMARY KEY (`Sor`)
...
-- Dump completed on 2018-03-12 21:18:59
